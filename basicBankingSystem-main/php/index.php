...
<body>
    ...
    <nav class="navbar py-2 navbar-expand-lg navbar-dark bg-dark">
        <div class="container-fluid">
            <a class="navbar-brand" href="#">TSFI BANK <img src="logo/logo.webp" alt="Bank" width="50" height="50"></a>
    ...
    <class class="welcome">
        <h2>
            <img src="logo/friend.webp" alt="Bank" width="75" height="75" style="font-weight: bold;"> <strong>Welcoming you in the most trusted TSFI Bank !</strong> <img src="logo/trust.webp" alt="Bank" width="75" height="75">
        </h2>
    </class>
        ...
        <footer class="bg-light text-center text-lg-start">
            ...
            <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2)">
                ...
                <a class="text-dark" href="https://www.thesparksfoundationsingapore.org/" target="_blank"> The Sparks
                    Foundation <img src="logo/TSFI.png" alt="" width="40" height="35"></a>
            </div>
            <!-- Copyright -->
        </footer>
    </div>
